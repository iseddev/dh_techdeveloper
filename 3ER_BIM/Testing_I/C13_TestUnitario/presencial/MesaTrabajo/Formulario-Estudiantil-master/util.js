exports.generateText = (name, age, level) => {
  ...
  if(age>65) {
    ...
    return `No pudimos registrar a: ${student.name}. Por favor contacta a soporte@dh.com para más información.`
  }
  return `Edad ingresada no válida. Por favor intenta nuevamente.`
}
