...
const newArticle = generadorArticulos(
  "Este es titulo del articulo que creé",
  "Esta es la descripción del articulo que creé"
)
console.log(newArticle)

contArticulos.innerHTML += newArticle
//Forma mas simplificada
contArticulos.innerHTML += generadorArticulos(
  "Titulo de mi segundo articulo",
  "Descripcion de mi segundo articulo"
)
contArticulos.innerHTML += generadorArticulos(
  "Titulo de mi tercero articulo",
  "Descripcion de mi tercero articulo"
)
...
generadorElementos(
  "Esto lo creé con createElement",
  "Super útil ésta herramienta"
)
generadorElementos(
  "Esto lo creé con createElement",
  "Super útil ésta herramienta"
