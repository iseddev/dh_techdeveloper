...
//Attributes
const btn = document.querySelector("#ejemplo-boton")
console.log(btn)

//hasAttribute => nos devuelve un boolean
console.log(btn.hasAttribute("id"))
console.log(btn.hasAttribute("style"))

//getAttribute
console.log(btn.getAttribute("id")) // me devuelve el valor del atributo
...
img.setAttribute("alt", peliculas[0].titulo)
...
peliculas.forEach((pelicula) => {
  ...
  //Seteo los valores de cada elemento
  h2.textContent = pelicula.titulo
  img.setAttribute("src", pelicula.imagen)
  img.setAttribute("alt", pelicula.titulo)
  article.setAttribute("puntaje", pelicula.puntaje) //Creo un atributo nuevo

  //Operación para saber el puntaje máximo dentro de las peliculas
  if (maxPuntaje < pelicula.puntaje) {
    maxPuntaje = pelicula.puntaje
  }

  //Sumo los elementos h2 y img al contenedor article
