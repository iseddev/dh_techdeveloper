		...
		<Layout>
			<main>
				<div className={styles.homeHeader}>
					<h1 className={styles.homeHeader__title}>Trabajo Integrador Final</h1>
					<h2 className={styles.homeHeader__subtitle}>Frontend III - React</h2>
				</div>
				<div className={styles.homeContent}>
					<p>
						En este trabajo integrador final, se desarrolló una aplicación web que permite
						visualizar información sobre personajes de la serie de televisión <b>Dragon Ball</b> .
						Para ello, se utilizó la API pública{" "}
