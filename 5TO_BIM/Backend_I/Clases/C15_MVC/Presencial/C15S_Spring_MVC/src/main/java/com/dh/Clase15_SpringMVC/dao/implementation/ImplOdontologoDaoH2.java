package com.dh.Clase15_SpringMVC.dao.implementation;
...
public class ImplOdontologoDaoH2 implements IDao<Odontologo> {

  private static final Logger LOGGER = Logger.getLogger(ImplPacienteDaoH2.class);
  ...
  public Odontologo actualizar(Odontologo odontologo) {
    ...
    try {
      connection = BD.getConnection();
      LOGGER.info("Se inicia la modificación del odontólogo con id: " + odontologo.getId());
