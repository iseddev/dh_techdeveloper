...
public class DB {
	...
	private static final String DB_PATH_NAME = "jdbc:h2:./estudiante_db";
	...
	private static final String CREATE_TABLE = "DROP TABLE IF EXISTS estudiantes; CREATE TABLE estudiantes " +
			"(id INT PRIMARY KEY, " +
